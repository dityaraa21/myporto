...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm("service_yyo7iiu", "template_taxuv0p", form.current, "8FbbdtyhKdPA5wdvU");
    e.target.reset();
        ...
        <div className="contact__content">
          ...
          <form ref={form} onSubmit={sendEmail} className="contact__form">
            ...
            <div className="contact__form-div contact__form-area">
              ...
              <textarea name="project" cols="30" rows="10" className="contact__form-input" placeholder="Description"></textarea>
            </div>
